...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-brand-dark text-white/90 pt-16 md:pt-24 pb-10 md:pb-12">
                      ...
                      <>
                        <div
                          className={`w-12 h-12 bg-white rounded-lg p-1.5 flex items-center justify-center transition-all ${
                            isActive ? 'ring-2 ring-brand-green ring-offset-2 ring-offset-brand-dark' : ''
                          }`}
                        >
                          <img
                            src={src}
                ...
                <div className="flex gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer noopener"
                      className="inline-flex text-[10px] uppercase tracking-[0.24em] font-bold text-brand-muted hover:text-white transition-colors"
                    >
                      {(t as any).mapNav}
                    </a>
                  </div>
